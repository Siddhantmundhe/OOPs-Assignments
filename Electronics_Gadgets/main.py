...
db_connector = DatabaseConnector(host ="localhost", database ="techshop", user ="root", password ="Akku@143")
...
customers_manager.update_customer_Info("114", "siddhant13@gmail.com", "123458907", "Vadgoan,Pune")
